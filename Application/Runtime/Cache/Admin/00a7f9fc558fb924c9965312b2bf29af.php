        ...
        <div class="am-g">
                <div class="am-u-sm-12 am-u-md-12">
                    ...
                    <div class="am-tab-panel">
                        <form class="am-form " action="<?php echo U('Admin/Auth/group_store');?>" method="post">
                                    ...
                                    <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><div class="am-panel am-panel-default">
                                        ...
                                        <div class="am-panel-hd">
                                            <label class="am-checkbox-inline am-danger">
                                                <input data-am-ucheck="" type="checkbox" value="<?php echo ($list["id"]); ?>" name="rule_id[]" class="permission1 am-ucheck-checkbox"><span class="am-ucheck-icons"><i class="am-icon-unchecked"></i><i class="am-icon-checked"></i></span><span class="am-ucheck-icons"><i class="am-icon-unchecked"></i><i class="am-icon-checked"></i></span>
                                        ...
                                        <?php if(is_array($list["son"])): $i = 0; $__LIST__ = $list["son"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="am-panel-bd">
                                            <div class="am-g am-margin-top ">
                                                <div class="am-u-sm-4 am-u-md-3 am-text-right permission-div2">
                                                    <label class="am-checkbox-inline am-danger">
                                                        <input data-am-ucheck="" type="checkbox" value="<?php echo ($vo["id"]); ?>" name="rule_id[]" class="permission2 am-ucheck-checkbox"><span class="am-ucheck-icons"><i class="am-icon-unchecked"></i><i class="am-icon-checked"></i></span><span class="am-ucheck-icons"><i class="am-icon-unchecked"></i><i class="am-icon-checked"></i></span>
                                                ...
                                                <div class="am-u-sm-8 am-u-md-9 am-u-end col-end permission-div3">
                                                    ...
                                                    <?php if(is_array($vo["son"])): $i = 0; $__LIST__ = $vo["son"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$child): $mod = ($i % 2 );++$i;?><label class="am-checkbox-inline  am-danger">
                                                        <input data-am-ucheck="" type="checkbox" value="<?php echo ($child["id"]); ?>" class="permissions3 am-ucheck-checkbox" name="rule_id[]"><span class="am-ucheck-icons"><i class="am-icon-unchecked"></i><i class="am-icon-checked"></i></span>
