        ...
        <ul class="am-list admin-sidebar-list">
            ...
            <?php if(is_array($menus)): $i = 0; $__LIST__ = $menus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menu): $mod = ($i % 2 );++$i;?><li class="admin-parent">
                ...
                <ul class="am-list admin-sidebar-sub am-collapse am-in" id="collapse-<?php echo ($menu["id"]); ?>">
                    <?php if(is_array($menu["children"])): $i = 0; $__LIST__ = $menu["children"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U($vo['name']);?>"><span class="am-icon-th"></span> <?php echo ($vo["title"]); ?><span class="am-badge am-badge-secondary am-margin-right am-fr">24</span></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
            ...
            <div class="am-u-sm-12 am-u-md-6">
                <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                        <a href="<?php echo U('Admin/Auth/rule_add');?>" class="am-btn am-btn-default"><span class="am-icon-plus"></span> 新增</a>
                ...
                <form class="am-form">
                    <table class="am-table am-table-striped am-table-hover table-main">
                        ...
                        <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <?php if(is_array($list["son"])): $i = 0; $__LIST__ = $list["son"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$children): $mod = ($i % 2 );++$i;?><tr>
                                <td><input type="checkbox"></td>
                                ...
                                <?php if(is_array($children["son"])): $i = 0; $__LIST__ = $children["son"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$child): $mod = ($i % 2 );++$i;?><tr>
                                        <td><input type="checkbox"></td>
